# -*- coding: utf-8 -*-
# @Time    : 2019/7/26 19:28
# @Author  : RIO
# @desc: RNN classifier for MNIST dataset, cells are basic type or LSTM-type.
...
loss_readout.to_csv('MNIST_data/RNN_LSTM_loss.csv')
acc_readout = pd.DataFrame(accuracy_list)
acc_readout.to_csv('MNIST_data/RNN_LSTM_accuracy.csv')